/**
 * POST D:\NXTFLUTTER_CORE\underpeaks-core\main\app\api\save-db-config\route.ts
 *
 ...
 * the Underpeaks installer wizard.
 *
...
async function writeEnvFileFromObject(env: Record<string, any>): Promise<void> {
  ...
  const lines: string[] = ['# Generated by Underpeaks Installer']
