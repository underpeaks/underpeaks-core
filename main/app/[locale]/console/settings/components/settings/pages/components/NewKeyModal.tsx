      ...
      <div className="bg-white rounded-xl shadow-2xl p-6 max-w-md w-full mx-4">
        ...
        <div className="flex items-center justify-between mb-4">
          <div className="flex items-center gap-2">
            ...
            <h3 className="text-sm font-semibold text-gray-900">API Key Generated</h3>
          </div>
        ...
        <div className="flex flex-col items-center gap-3 py-4">
          ...
          <p className="text-xs text-gray-500 text-center">
            Your key has been created and is ready to use.
            Click the <span className="font-medium text-gray-700">eye icon</span> next
            to the key in the list to reveal and copy it.
          </p>
          <p className="text-xs font-mono text-gray-400">{result.prefix}••••••••••••••••••••</p>
        </div>
