...
function SelectTrigger({
  ...
  return (
    <SelectPrimitive.Trigger
      ...
      data-size={size}
      className={cn(
        // ✅ FIXED LAYOUT (this is the actual issue fix)
        "flex w-full items-center justify-between gap-2",
        "rounded-lg border border-input bg-transparent",
        "px-3 py-2 text-[15px] text-left",
        "h-10",

        // existing ShadCN behavior
  ...
  return (
    <SelectPrimitive.Item
      ...
      className={cn(
        ...
        "py-2 px-3 text-[15px] text-left", // ✅ bigger + left aligned + spacing
    ...
    >
      ...
      <SelectPrimitive.ItemText className="w-full text-left">
        {children}
